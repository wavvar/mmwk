...
`modules/` 目录当前覆盖三条产品线：[RPX](./rpx_cn.md)、[WDR](./wdr-m_cn.md) + [ML6432Ax](./ml6432ax_cn.md)，以及 [F9](./f9a1_cn.md)。下面按照系列进行纵览，帮助读者快速理解产品关系，并跳转到对应的详细文档。
...
`WDR` 是围绕 `ML6432Ax` 雷达板构建的系统级产品系列。[WDR-M 硬件文档](./wdr-m_cn.md)说明该系统中的主控板角色。

- `WDR` 是完整模组，由 `ML6432A_BO` 雷达板、`WDR-M` 主控板和 `4G Cat1` 通信板组成。
- [`WDR-M`](./wdr-m_cn.md) 是负责供电、控制、调试和板间互连的主控承载板。
...
- 系统与主控总览： [WDR-M 主控承载板简介](./wdr-m_cn.md) | [English](./wdr-m.md)
- 通信板文档： [WDR-4G 通信板简介](./wdr-4g_cn.md) | [English](./wdr-4g.md)
