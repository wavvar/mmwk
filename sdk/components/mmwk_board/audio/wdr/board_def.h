...
/* I2S port and GPIOs - placeholder values for RPI board */
#define I2S_NUM         (0)
...
/*
 * Camera Function Definition (no camera on RPI by default)
 */
...
/* SD Card pins (not supported on RPI) */
...
/* Audio codec configuration (RPI board has no real codec) */
