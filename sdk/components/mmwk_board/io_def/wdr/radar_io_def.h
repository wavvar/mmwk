...
* USB for 4G modules
*/
#define MMWK_IO_USB_SWITCH_CTL       (16)
#define MMWK_USB_SWITCH_USB_LEVEL   (0)
#define MMWK_USB_SWITCH_UART_LEVEL  (1)
#define MMWK_USB_SWITCH_MODEM_LEVEL MMWK_USB_SWITCH_UART_LEVEL
#define MMWK_IO_IOT_PWR_CTL  (21)
#define MMWK_IO_IOT_UART_TX  (42)
#define MMWK_IO_IOT_UART_RX  (41)
