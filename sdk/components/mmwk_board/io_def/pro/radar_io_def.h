 ...
 * User Interaction
 */
#define MMWK_IO_KEY              (33)
#define MMWK_IO_KEY_SECOND       (-1)
#define MMWK_IO_LED              (48)
...
#define MMWK_IO_RADAR_SPI_INT        (16)
...
#define MMWK_IO_RADAR_DATA_RX        (12)
...
#define MMWK_IO_IOT_UART_TX  (36)
#define MMWK_IO_IOT_UART_RX  (37)
#define MMWK_IO_IOT_USB_DM   (19)
#define MMWK_IO_IOT_USB_DP   (20)
#define MMWK_IO_IOT_RESET    (35)
...
#define MMWK_IO_VEML6030_INT (18)
#define MMWK_IO_BMI160_INT   (34)
